'use client'
// src/app/demo/projetos/[id]/page.tsx — Detalhes do Projeto
...
import { getDeadlineBadge, gerarMitigacao } from '../../_utils'
...
export default function DemoProjetoDetailPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
    ...
    <div className="p-8 max-w-5xl">
      ...
      <div className="flex items-start justify-between mb-7 gap-4">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <Link href={`/demo/projetos/${project.id}/editar`}
